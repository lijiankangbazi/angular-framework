...
/***/ function(module, exports) {
	...
	function pagination() {
	  return {
	    ...
	    setPage: function setPage(pageObj, data) {
...
/***/ function(module, exports) {
	...
	module.exports = angular.module('constant', []).constant('CONSTANTS', {
		baseUrl: "/api/"
	}).name;
...
/***/ function(module, exports) {
	...
	function http($state, CONSTANTS) {
		return {
			...
			request: function request(url, data, method) {
